...
const NavMenu: React.FC = () => {
    ...
    return (
        <div className="hidden md:block relative">
            ...
            <nav ref={menuRef} className={`absolute bg-white shadow-lg dark:shadow-transparent dark:bg-bg-100 rounded-lg flex flex-col items-stretch justify-center text-lg text-left w-64 top-[130%] right-0 duration-300 ${isMenuActive ? "opacity-1 z-50 translate-y-0" : "opacity-0 -z-50 -translate-y-5"}`}>
